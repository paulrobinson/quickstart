...
public class SetServiceBAService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(SetServiceBAService.class.getName());
	...
	public SetServiceBAService() {
		super(SETSERVICEBASERVICE_WSDL_LOCATION, new QName(
				"http://www.jboss.com/jbosstm/xts/quickstarts/Set",
				"SetServiceBAService"));
	}
	...
	public SetServiceBA getSetServiceBA() {
		return super.getPort(new QName(
				"http://www.jboss.com/jbosstm/xts/quickstarts/Set",
				"SetServiceBA"), SetServiceBA.class);
	}
