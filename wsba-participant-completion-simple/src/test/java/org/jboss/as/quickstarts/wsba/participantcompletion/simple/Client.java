...
public class Client implements SetServiceBA {
	...
	/**
	 * Default constructor with hard-coded values for the SetService endpoint
	 * details (wsdl url, service name & port name)
	 * 
	...
	public Client() throws MalformedURLException {
		URL wsdlLocation = new URL(
				"http://localhost:8080/wsba/SetServiceBA?wsdl");
		QName serviceName = new QName(
				"http://www.jboss.com/as/quickstarts/helloworld/wsba/participantcompletion/set",
				"SetServiceBAService");
		...
		/*
		 * Add client handler chain so that XTS can add the transaction context
	 ...
	 *             if an error occurred during the adding of the item to the
	 *             set.
	 */
