...
public class RestaurantParticipant implements Durable2PCParticipant, Serializable {
     ...
     */
    public RestaurantParticipant(String txID, String bookingName) {
        this.txID = txID;
    ...
    public void commit() throws WrongStateException, SystemException {
        ...
        {
            System.out.println("[SERVICE] Not crashing the service");
        }
        ...
        System.out.println("[SERVICE] Committing booking for name '" + bookingName + "'");
