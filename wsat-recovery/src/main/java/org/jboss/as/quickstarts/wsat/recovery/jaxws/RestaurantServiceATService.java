 ...
 * 
 */
@WebServiceClient(name = "RestaurantServiceATService", targetNamespace = "http://www.jboss.org/jboss-jdf/jboss-as-quickstart/wsat/recovery/Restaurant")
public class RestaurantServiceATService extends Service {
    ...
    public RestaurantServiceATService() {
        super(RESTAURANTSERVICEATSERVICE_WSDL_LOCATION, new QName(
                "http://www.jboss.org/jboss-jdf/jboss-as-quickstart/wsat/recovery/Restaurant", "RestaurantServiceATService"));
    }
    ...
    public RestaurantServiceAT getRestaurantServiceAT() {
        return super.getPort(
                new QName("http://www.jboss.org/jboss-jdf/jboss-as-quickstart/wsat/recovery/Restaurant", "RestaurantServiceAT"),
