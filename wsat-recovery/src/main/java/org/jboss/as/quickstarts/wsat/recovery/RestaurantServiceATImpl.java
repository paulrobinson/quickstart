 ...
 * 
 */
@WebService(serviceName = "RestaurantServiceATService", portName = "RestaurantServiceAT", name = "RestaurantServiceAT", targetNamespace = "http://www.jboss.org/jboss-jdf/jboss-as-quickstart/wsat/recovery/Restaurant")
...
public class RestaurantServiceATImpl implements RestaurantServiceAT {
    ...
    public void makeBooking(String bookingName) throws RestaurantException {
        ...
        try {
            ...
            RestaurantParticipant restaurantParticipant = new RestaurantParticipant(transactionId, bookingName);
