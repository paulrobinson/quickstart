...
public class Client implements RestaurantServiceAT {
    ...
    public Client() throws MalformedURLException {
        URL wsdlLocation = new URL("http://127.0.0.3:8080/jboss-as-wsat-recovery/RestaurantServiceATService?wsdl");
        QName serviceName = new QName("http://www.jboss.org/jboss-jdf/jboss-as-quickstart/wsat/recovery/Restaurant",
                "RestaurantServiceATService");
        QName portName = new QName("http://www.jboss.org/jboss-jdf/jboss-as-quickstart/wsat/recovery/Restaurant", "RestaurantServiceAT");
     ...
     */
    @Override
    public void makeBooking(String bookingName) throws RestaurantException {
        restaurant.makeBooking(bookingName);
    }
}
